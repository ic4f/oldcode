...
namespace IrProject.Core
{
    public class AppException : System.Exception
    {
        ...
        public static void LogError(Exception ex, string message)
        {
            ...
            string errorFile = System.Configuration.ConfigurationSettings.AppSettings["ErrorLogFile"];
            string detailsFile = System.Configuration.ConfigurationSettings.AppSettings["ErrorDetailsFile"];
