<%@ Page Language="c#" CodeBehind="roleUsers.aspx.cs" AutoEventWireup="false" Inherits="Ei.Website.settings.roleUsers" %>
...
<body>
    <form id="Form1" method="post" runat="server">
        ...
        <asp:Panel ID="pnlForm" CssClass="panel-form" runat="server">
            ...
            <p>
                <cc:DataCheckboxList id="cblUsers" style="font-size: 11px;" runat="server" />
            </p>
