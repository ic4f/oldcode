<%@ Page Language="c#" CodeBehind="lineupAdminister.aspx.cs" AutoEventWireup="false" Inherits="Ei.Website.lineupadmin.lineupAdminister" %>
                            ...
                            <cc:MySortGrid id="dgrLineups" cssclass="gridTableData" DataKeyField="Id" runat="server">
                                <columns>								
									...
									<asp:HyperlinkColumn text="select"
										DataNavigateUrlField="Id" DataNavigateUrlFormatString="lineupAdminister2.aspx?Id={0}">
