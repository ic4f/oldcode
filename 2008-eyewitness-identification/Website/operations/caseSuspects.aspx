<%@ Page Language="c#" CodeBehind="caseSuspects.aspx.cs" AutoEventWireup="false" Inherits="Ei.Website.operations.caseSuspects" %>
...
<body>
    <form id="Form1" method="post" runat="server">
        ...
        <asp:Panel ID="pnlForm" CssClass="panel-form" runat="server">
            ...
            <p>
                <cc:DataCheckboxList id="cblSuspects" runat="server" />
            </p>
