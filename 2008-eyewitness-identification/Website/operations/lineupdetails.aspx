<%@ Page Language="c#" CodeBehind="lineupdetails.aspx.cs" AutoEventWireup="false" Inherits="Ei.Website.operations.lineupDetails" %>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <p>
            <div style="border: 1px red solid; background-color: #f1f1f1; padding: 10px; text-align: center;">
                <asp:Button ID="btnDelete" CssClass="button" Text="Delete This Lineup" runat="server" />
