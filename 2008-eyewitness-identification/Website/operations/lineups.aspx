<%@ Page Language="c#" CodeBehind="lineups.aspx.cs" AutoEventWireup="false" Inherits="Ei.Website.operations.lineups" %>
                            ...
                            <cc:MySortGrid id="dgrLineups" cssclass="gridTableData" DataKeyField="Id" runat="server">
                                <columns>								
									...
									<asp:HyperlinkColumn text="results"
										DataNavigateUrlField="Id" DataNavigateUrlFormatString="results.aspx?LineupId={0}">
										<ItemStyle HorizontalAlign="Center" width="80"/>
									</asp:HyperlinkColumn>																															
								</columns>
                            </cc:MySortGrid>
