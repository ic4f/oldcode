<%@ Page Language="c#" CodeBehind="caseUsers.aspx.cs" AutoEventWireup="false" Inherits="Ei.Website.operations.caseUsers" %>
...
<body>
    <form id="Form1" method="post" runat="server">
        ...
        <asp:Panel ID="pnlForm" CssClass="panel-form" runat="server">
            ...
            <p>
                <cc:DataCheckboxList id="cblUsers" runat="server" />
            </p>
