...
namespace Ei.Data
{
    public class Suspect : DataClass
    {
        #region constructor
        ...
        public int Update()
        {
            SqlCommand command = new SqlCommand("Suspect_Update", Connection);
        ...
        {
            SqlCommand command = new SqlCommand("Suspect_Get", Connection);
            command.CommandType = CommandType.StoredProcedure;
            ...
            if (reader[5] != System.DBNull.Value)
                hairColorId = reader.GetInt32(5);

            if (reader[6] != System.DBNull.Value)
                ageRangeId = reader.GetInt32(6);

            if (reader[7] != System.DBNull.Value)
                weightRangeId = reader.GetInt32(7);
            ...
            if (reader[11] != System.DBNull.Value)
                race = reader.GetString(11);

            if (reader[12] != System.DBNull.Value)
                hairColor = reader.GetString(12);

            if (reader[13] != System.DBNull.Value)
                ageRange = reader.GetString(13);

            if (reader[14] != System.DBNull.Value)
                weightRange = reader.GetString(14);
