<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="departmentList.aspx.vb" Inherits="Foundation.WebMain.departmentList" %>
...
<body>
    <form id="Form1" method="post" runat="server">
        ...
        <asp:Repeater ID="rptDepartments" runat="server">
            <ItemTemplate>
                <p>
                    <asp:HyperLink ID="lnkDepartment" runat="server" /></p>
            </ItemTemplate>
        </asp:Repeater>
