<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="roleUsers.aspx.vb" Inherits="Foundation.WebAdmin.settings.roleUsers" %>
...
<body>
    <form id="Form1" method="post" runat="server">
        ...
        <asp:Panel ID="pnlForm" CssClass="panel-form" runat="server">
            ...
            <p>
                <cc:DataCheckboxList ID="cblUsers" Style="font-size: 11px;" runat="server" /></p>
