<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="programColleges.aspx.vb" Inherits="Foundation.WebAdmin.giving.programColleges" %>
...
<body>
    <form id="Form1" method="post" runat="server">
        ...
        <asp:Panel ID="pnlForm" CssClass="panel-form" runat="server">
            ...
            <p>
                <cc:DataCheckboxList ID="cblColleges" runat="server" /></p>
