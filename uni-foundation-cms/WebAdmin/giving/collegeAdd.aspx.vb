    ...
    Public Class collegeAdd
        ...
        Protected Overrides Function SaveItem() As Integer
            If Page.IsValid Then
                ...
                Dim dtCat As New dt.PageCategory(ba.PageCategoryCode.College)
                ...
                Dim pageCat As Integer = ba.PageCategoryCode.College
                ...
                If newPageId > 0 Then
                    Dim collegeId As Integer = New dt.CollegePageData().Create(newPageId)
