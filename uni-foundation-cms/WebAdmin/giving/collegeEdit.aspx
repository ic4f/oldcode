<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="collegeEdit.aspx.vb" Inherits="Foundation.WebAdmin.giving.collegeEdit" %>
        ...
        <asp:Panel ID="pnlForm" CssClass="panel-form" runat="server">
            ...
            <p>
                <table width="100%" cellpadding="0" cellspacing="0" style="font-size: 11px;">
                    <tr valign="top">
                        <td width="80%">
                            <p class="field-title">College Description</p>
                            <p class="field-input">
