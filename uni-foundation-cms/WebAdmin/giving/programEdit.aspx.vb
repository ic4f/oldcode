...
Namespace giving
    ...
    Public Class programEdit
        ...
        Private Sub BindData()
            ...
            Dim myprog As New dt.ProgramPage(New dt.ProgramPageData().GetIdByPageId(pageId))

            cbxFeatured.Checked = myprog.IsFeatured
        ...
        Protected Overrides Function SaveItem() As Integer
            If Page.IsValid Then
                ...
                If result > 0 Then
                    Dim myprog As New dt.ProgramPage(New dt.ProgramPageData().GetIdByPageId(pageId))
                    myprog.IsFeatured = cbxFeatured.Checked
                    myprog.Update()
