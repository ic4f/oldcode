<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="programList.aspx.vb" Inherits="Foundation.WebAdmin.giving.programList" %>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <table style="border: 1px #cacaca solid; background-color: #f1f1f1; font-size: 11px;" cellspacing="0" cellpadding="3">
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlCollege" CssClass="textbox" Style="width: 200px;" runat="server" /></td>
            </tr>
            <tr>
            ...
            <tr>
                <td></td>
                <td>
                    <asp:Button ID="btnSearch" CssClass="button" Text="Find Program Pages" runat="server" />
                    ...
                    <td>
                        <cc:MySortGrid ID="dgrPages" CssClass="gridTableData" DataKeyField="Id" runat="server">
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="pagetitle" SortExpression="p.pagetitle" HeaderText="Program">
                                ...
                                <asp:HyperLinkColumn Text="set colleges"
                                    DataNavigateUrlField="Id" DataNavigateUrlFormatString="programColleges.aspx?Id={0}">
                                ...
                                <asp:HyperLinkColumn Text="edit/publish"
                                    DataNavigateUrlField="Id" DataNavigateUrlFormatString="programEdit.aspx?Id={0}">
