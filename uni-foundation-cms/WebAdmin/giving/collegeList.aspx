<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="collegeList.aspx.vb" Inherits="Foundation.WebAdmin.giving.collegeList" %>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <table style="border: 1px #cacaca solid; background-color: #f1f1f1; font-size: 11px;" cellspacing="0" cellpadding="3">
            ...
            <tr>
                <td></td>
                <td>
                    <asp:Button ID="btnSearch" CssClass="button" Text="Find College Pages" runat="server" />
                    ...
                    <td>
                        <cc:MySortGrid ID="dgrPages" CssClass="gridTableData" DataKeyField="Id" runat="server">
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="pagetitle" SortExpression="p.pagetitle" HeaderText="College">
                                ...
                                <asp:HyperLinkColumn Text="edit/publish"
                                    DataNavigateUrlField="Id" DataNavigateUrlFormatString="collegeEdit.aspx?Id={0}">
