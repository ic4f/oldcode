<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="departmentList.aspx.vb" Inherits="Foundation.WebAdmin.giving.departmentList" %>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <table style="border: 1px #cacaca solid; background-color: #f1f1f1; font-size: 11px;" cellspacing="0" cellpadding="3">
            ...
            <tr>
                <td></td>
                <td>
                    <asp:Button ID="btnSearch" CssClass="button" Text="Find Department Pages" runat="server" />
                    ...
                    <td>
                        <cc:MySortGrid ID="dgrPages" CssClass="gridTableData" DataKeyField="Id" runat="server">
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="pagetitle" SortExpression="p.pagetitle" HeaderText="Department">
                                    <HeaderStyle Wrap="False" />
                                </asp:BoundColumn>
                                <asp:BoundColumn DataField="college" SortExpression="college" HeaderText="College">
                                    <HeaderStyle Wrap="False" />
                                </asp:BoundColumn>
                                ...
                                <asp:HyperLinkColumn Text="edit/publish"
                                    DataNavigateUrlField="Id" DataNavigateUrlFormatString="departmentEdit.aspx?Id={0}">
