<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="pageList.aspx.vb" Inherits="Foundation.WebAdmin.webpages.pageList" %>
                        ...
                        <cc:MySortGrid ID="dgrPages" CssClass="gridTableData" DataKeyField="Id" runat="server">
                            <Columns>
                                ...
                                <asp:HyperLinkColumn Text="edit/publish"
                                    DataNavigateUrlField="Id" DataNavigateUrlFormatString="pageEdit.aspx?Id={0}">
                                    <ItemStyle HorizontalAlign="Center" Width="80px" />
                                </asp:HyperLinkColumn>
