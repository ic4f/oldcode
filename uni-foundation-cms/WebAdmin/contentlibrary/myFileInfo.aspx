<%@ Page Language="vb" AutoEventWireup="false" Codebehind="myFileInfo.aspx.vb" Inherits="Foundation.WebAdmin.contentlibrary.myFileInfo"%>
...
<asp:panel id="pnlCanDelete" runat="server" style="border:1px solid red;padding:10px;background-color:#f6f6f6;width:560px;" visible="false">
	<p style="font-weight:bold;color:#444444;font-size:14px;margin-bottom:5px;"">Delete File</p>
	There are no pages that link to this file. To delete this file, press the button below. This operation cannot be undone.
	<p align="center"><asp:button id="btnDelete" cssclass="button" text="Delete File" runat="server"/></p>
</asp:panel>
...
<asp:panel id="pnlDependencies" runat="server" style="border:1px solid #cacaca;padding:10px;" visible="false">
	...
	You <span style="color:maroon;">cannot delete</span> this file because of the following dependencies:
	
	<div style="margin-left:20px;">
				
		<p>
		<asp:panel id="pnlDependPages" runat="server" visible="false">
			<p><b>File References:</b> <asp:literal id="ltrInboundPageLinks" runat="server"/></p>
