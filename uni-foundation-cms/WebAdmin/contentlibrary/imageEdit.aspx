<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="imageEdit.aspx.vb" Inherits="Foundation.WebAdmin.contentlibrary.imageEdit" %>
...
<body>
    <form id="Form1" method="post" runat="server">
        ...
        <asp:Panel ID="pnlConfirm" CssClass="panel-confirm" runat="server">
            ...
            <p>
                <asp:Literal ID="ltrPreview2" runat="server" />
                <div class="buttons">
        ...
        <asp:Panel ID="pnlForm" runat="server">
            ...
            <div class="panel-form">
                ...
                <p class="field-input">
                    <asp:TextBox ID="tbxWidth" Style="width: 35px;" MaxLength="4" CssClass="textbox" runat="server" />
                    pixels</p>

                <p class="field-title">Maximum Height</p>
                <p class="field-input">
                    <asp:TextBox ID="tbxHeight" Style="width: 35px;" MaxLength="4" CssClass="textbox" runat="server" />
                    pixels</p>
            ...
            <p>
                ...
                <div class="panel-form">
                    ...
                    <p style="font-size: 11pt; font-weight: bold; color: #414141;" align="center">Edit Image Information</p>
