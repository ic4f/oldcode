<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="tagEdit.aspx.vb" Inherits="Foundation.WebAdmin.contentorg.tagEdit" %>
...
<body>
    <form id="Form1" method="post" runat="server">
        ...
        <asp:Panel ID="pnlForm" CssClass="panel-form" runat="server">
            <p class="field-title">Tag Text*</p>
            <p class="field-input">
                <asp:TextBox CssClass="textbox" ID="tbxText" runat="server" Style="width: 300px;" MaxLength="50" />
                <asp:RequiredFieldValidator ID="valText" ErrorMessage="<br>Please provide the tag text" ControlToValidate="tbxText" runat="server" />
                <asp:CustomValidator ID="valUnique" ErrorMessage="<br>This tag exists: please choose a different tag text" runat="server" />
            </p>
