...
namespace Giggle.Data
{
    ...
    public class AHPageGraph
    {
        ...
        private short cursor; //keeps track of current number of pages
        ...
        public void AddLink(short fromDocId, short toDocId)
        {
            if (!pagesAdded)
            {
            ...
            short fromId = Convert.ToInt16(globalIds[fromDocId]);
            short toId = Convert.ToInt16(globalIds[toDocId]);
        ...
        private AHDocument[] getScores(AHDocumentComparer comparer)
        {
            ...
            for (short id = 0; id < results.Length; id++)
