...
Namespace giving
    ...
    Public Class collegeList
        ...
        Private Sub BindData()
            ...
            If (ddlStatus.SelectedIndex > 0 Or ddlLabel.SelectedIndex > 0 Or ddlTag.SelectedIndex > 0 Or keywords <> "") Then
                pages = New dt.CollegePageData().GetCollegePagesWithQuery(makeQuery(keywords))
            Else
                pages = New dt.CollegePageData().GetCollegePages(dgrPages.SortExpression)
            End If
