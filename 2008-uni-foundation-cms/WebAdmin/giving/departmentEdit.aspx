<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="departmentEdit.aspx.vb" Inherits="Foundation.WebAdmin.giving.departmentEdit" %>
...
<body>
    <form id="Form1" method="post" runat="server">
        ...
        <asp:Panel ID="pnlForm" CssClass="panel-form" runat="server">
            ...
            <p class="field-input">
                <asp:DropDownList ID="ddlCollege" runat="server" /></p>
