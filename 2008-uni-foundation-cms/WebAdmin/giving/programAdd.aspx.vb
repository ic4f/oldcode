    ...
    Public Class programAdd
        ...
        Protected Overrides Function SaveItem() As Integer
            If Page.IsValid Then
                ...
                Dim dtCat As New dt.PageCategory(ba.PageCategoryCode.Program)
                ...
                Dim pageCat As Integer = ba.PageCategoryCode.Program
                ...
                If newPageId > 0 Then
                    Dim programId As Integer = New dt.ProgramPageData().Create(newPageId, cbxFeatured.Checked)
