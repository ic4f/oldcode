<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="departmentAdd.aspx.vb" Inherits="Foundation.WebAdmin.giving.departmentAdd" %>
...
<body>
    <form id="Form1" method="post" runat="server">
        ...
        <asp:Panel ID="pnlForm" CssClass="panel-form" runat="server">
            ...
            <p class="field-title">College*</p>
            <p class="field-input">
                <asp:DropDownList ID="ddlCollege" runat="server" />
                <asp:RequiredFieldValidator ID="val5" ControlToValidate="ddlCollege" Text=" - Please select a college" runat="server" />
            </p>
            ...
            <p>
                <table width="100%" cellpadding="0" cellspacing="0" style="font-size: 11px;">
                    <tr valign="top">
                        <td width="80%">
                            <p class="field-title">Department Description</p>
                            <p class="field-input">
