...
Namespace giving
    ...
    Public Class departments
        ...
        Private Sub DisplayContent()
            ...
            If HasPermission(ba.PermissionCode.Giving_Departments_View) Or
            HasPermission(ba.PermissionCode.Giving_Departments_ViewModify) Or
            HasPermission(ba.PermissionCode.Giving_Departments_ViewModifyPublish) Then
                pnlView.Visible = True
            End If
            If HasPermission(ba.PermissionCode.Giving_Departments_ViewModify) Or
            HasPermission(ba.PermissionCode.Giving_Departments_ViewModifyPublish) Then
