...
Namespace giving
    ...
    Public Class programList
        ...
        Protected ddlFeatured As DropDownList
        ...
        Private Sub BindLists()
            ...
            ddlFeatured.Items.Clear()
            ddlFeatured.Items.Add(New ListItem("-- select all", "0"))
            ddlFeatured.Items.Add(New ListItem("featured", "1"))
            ddlFeatured.Items.Add(New ListItem("not featured", "2"))
        ...
        Private Sub BindData()
            ...
            If (ddlCollege.SelectedIndex > 0 Or ddlStatus.SelectedIndex > 0 _
              Or ddlFeatured.SelectedIndex > 0 Or ddlLabel.SelectedIndex > 0 Or ddlTag.SelectedIndex > 0 Or keywords <> "") Then
                pages = New dt.ProgramPageData().GetProgramPagesWithQuery(makeQuery(keywords))
            Else
                pages = New dt.ProgramPageData().GetProgramPages(dgrPages.SortExpression)
            End If
        ...
        Private Function makeQuery(ByVal keywords As String) As String
            ...
            If (ddlCollege.SelectedIndex > 0) Then
                sb.AppendFormat(" and pcl.collegepageid = {0} ", ddlCollege.SelectedValue)
            End If
            ...
            If (ddlFeatured.SelectedValue = "1") Then
                sb.Append(" and pr.isfeatured = 1 ")
            ElseIf (ddlFeatured.SelectedValue = "2") Then
                sb.Append(" and pr.isfeatured = 0 ")
            End If
