...
Namespace giving
    ...
    Public Class departmentEdit
        ...
        Private Sub BindData()
            ...
            Dim mydpt As New dt.DepartmentPage(New dt.DepartmentPageData().GetIdByPageId(pageId))
            ...
            ddlCollege.DataBind()
            ddlCollege.SelectedValue = mydpt.CollegePageId.ToString
        ...
        Protected Overrides Function SaveItem() As Integer
            If Page.IsValid Then
                ...
                If result > 0 Then
                    Dim mydpt As New dt.DepartmentPage(New dt.DepartmentPageData().GetIdByPageId(pageId))
                    mydpt.CollegePageId = Convert.ToInt32(ddlCollege.SelectedValue())
                    mydpt.Update()
