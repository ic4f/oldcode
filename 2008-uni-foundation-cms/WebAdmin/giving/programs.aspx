<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="programs.aspx.vb" Inherits="Foundation.WebAdmin.giving.programs" %>
...
<body>
    <form id="Form1" method="post" runat="server">
        ...
        <asp:Panel ID="pnlModify" runat="server" class="textcontentpanel">
            <p><a href="programAdd.aspx">New program</a></p>
            <p class="commentunderlink">Create new program</p>
        </asp:Panel>
        <p>
            <asp:Panel ID="pnlView" runat="server" class="textcontentpanel">
                <p><a href="programList.aspx">List of programs</a></p>
                <p class="commentunderlink">View, edit, delete programs, assign programs to colleges and departments</p>
            </asp:Panel>
