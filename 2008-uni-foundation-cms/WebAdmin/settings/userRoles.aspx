<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="userRoles.aspx.vb" Inherits="Foundation.WebAdmin.settings.userRoles" %>
...
<body>
    <form id="Form1" method="post" runat="server">
        ...
        <asp:Panel ID="pnlForm" CssClass="panel-form" runat="server">
            ...
            <p>
                <cc:DataCheckboxList ID="cblRoles" runat="server" /></p>
