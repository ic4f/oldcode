<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="pageEdit.aspx.vb" Inherits="Foundation.WebAdmin.webpages.pageEdit" %>
...
<body>
    <form id="Form1" method="post" runat="server">
        ...
        <asp:Panel ID="pnlForm" CssClass="panel-form" runat="server">
            ...
            <p>
                <table width="100%" cellpadding="0" cellspacing="0" style="font-size: 11px;">
                    <tr valign="top">
                        <td width="80%">
                            <asp:Panel ID="pnlBody" runat="server" Style="font-size: 11px;">
        ...
        <td class="labels-area">
            ...
            <asp:Literal ID="ltrMenuFrame" runat="server" />
