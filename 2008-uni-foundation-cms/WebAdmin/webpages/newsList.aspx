<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="newsList.aspx.vb" Inherits="Foundation.WebAdmin.webpages.newsList" %>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <table style="border: 1px #cacaca solid; background-color: #f1f1f1; font-size: 11px;" cellspacing="0" cellpadding="3">
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlHomepage" CssClass="textbox" Style="width: 200px;" runat="server" /></td>
            </tr>
            <tr>
                <td align="right">Highlighted:</td>
                <td>
                    <asp:DropDownList ID="ddlHighlighted" CssClass="textbox" Style="width: 200px;" runat="server" /></td>
            </tr>
            <tr>
            ...
            <tr>
                <td></td>
                <td>
                    <asp:Button ID="btnSearch" CssClass="button" Text="Find News Pages" runat="server" />
                        ...
                        <cc:MySortGrid ID="dgrPages" CssClass="gridTableData" DataKeyField="Id" runat="server">
                            <Columns>
                                ...
                                <asp:HyperLinkColumn Text="edit/publish"
                                    DataNavigateUrlField="Id" DataNavigateUrlFormatString="newsEdit.aspx?Id={0}">
