<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="newsEdit.aspx.vb" Inherits="Foundation.WebAdmin.webpages.newsEdit" %>
        ...
        <asp:Panel ID="pnlForm" CssClass="panel-form" runat="server">
            ...
            <p class="field-input">
                <div style="padding: 8px; border: 1px solid #cacaca; width: 508px;">
                    ...
                    <br>
                    <br>
                    For best results, provide an image which is at most
                    <asp:Literal ID="ltrWidth" runat="server" />
                    pixels wide and exactly 
            ...
            <p class="field-input">
                <div style="padding: 3px; border: 1px solid #cacaca; width: 518px;">
                    <p>
                        <asp:CheckBox ID="cbxHomepage" runat="server" />Displayed on homepage</p>
                    <p>
                        <asp:CheckBox ID="cbxHighlight" runat="server" />Highlighted</p>
                </div>
            </p>
