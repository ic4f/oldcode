...
Namespace webpages
    ...
    Public Class newsAdd
        ...
        Protected Overrides Sub ResetFormFields()
            ...
            cbxHighlight.Checked = False
        End Sub

        Protected Overrides Function SaveItem() As Integer
            If Page.IsValid Then

                Dim pageCat As Integer = ba.PageCategoryCode.News
                ...
                Dim displayDate As Boolean = False
                ...
                Dim newPageId As Integer = New dt.PageData().Create(
                  ...
                  False, displayDate, displayBookmarking, displayPrintable, False, False, partialUrl, admincomment, Identity.UserId)
                ...
                If newPageId > 0 Then
                    ...
                    If tbxFile.PostedFile.ContentLength > 0 Then
                        hasImage = True
                    End If
                    Dim newsId As Integer = New dt.NewsPageData().Create(newPageId, hasImage, cbxHomepage.Checked, cbxHighlight.Checked, summary)
                    If tbxFile.PostedFile.ContentLength > 0 Then
                        ProcessImage(newsId)
                    End If
