<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="collegeList.aspx.vb" Inherits="Foundation.WebMain.collegeList" %>
...
<body>
    <form id="Form1" method="post" runat="server">
        ...
        <asp:Repeater ID="rptColleges" runat="server">
            <ItemTemplate>
                <p>
                    <asp:HyperLink ID="lnkCollege" runat="server" /></p>
            </ItemTemplate>
        </asp:Repeater>
