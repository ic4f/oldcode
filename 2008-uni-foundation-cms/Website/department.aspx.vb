...
Public Class department
    ...
    Protected Sub BindData()
        Dim dptId As Integer = New dt.DepartmentPageData().GetIdByPageId(PageRecord.Id)
        rptPrograms.DataSource = New dt.ProgramPageData().GetPublishedProgramPagesByDepartment(dptId)
