...
{
    public class Tag : DataClass
    {
        #region constructor
        public Tag(int recordId) : base()
        {
            loadRecord(recordId);
        }
        #endregion
        ...
        public int Update()
        {
            SqlCommand command = new SqlCommand("Tag_Update", Connection);
        ...
        {
            SqlCommand command = new SqlCommand("Tag_Get", Connection);
            command.CommandType = CommandType.StoredProcedure;
